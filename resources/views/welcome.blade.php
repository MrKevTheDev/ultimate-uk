                                    ...
                                    m("table", {"class":"min-w-full"},
                                        [
                                            m("thead", {"class":"bg-white border-b"},
                                                m("tr",
                                                    [
                                                        m("th", {"class":"text-sm font-medium text-gray-900 px-6 py-4 text-left","scope":"col"},
                                                        ),
                                                        m("th", {"class":"text-sm font-medium text-gray-900 px-6 py-4 text-left","scope":"col"},
                                                            " First "
                                                        ),
                                            ...
                                            m("tbody",
                                                [
                                                    m("tr", {"class":"bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100"},
                                                        [
